...
<script>
		...
		var colors = [ 'rgba(255, 99, 132, 0.5)', 'rgba(54, 162, 235, 0.5)',
				...
				'rgba(232, 62, 140, 0.5)', 'rgba(108, 117, 125, 0.5)',
				'rgba(32, 201, 151, 0.5)', 'rgba(72, 2, 250, 0.5)',
				'rgba(2, 250, 23, 0.5)', 'rgba(255, 41, 41, 0.5)',
				'rgba(75, 192, 192, 0.5)', 'rgba(153, 102, 255, 0.5)',
				'rgba(255, 159, 64, 0.5)', 'rgba(232, 62, 140, 0.5)',

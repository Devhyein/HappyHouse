...
//	 */
	...
	public List<HouseDeal> searchAll(int currentPage, int sizePerPage, String[] type) throws SQLException;
	 ...
	 * area, int floor, String jibun, String type, String rentMoney) throws
	 * SQLException;
	 */	
